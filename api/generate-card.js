...
export default async function handler(req, res) {
    ...
    try {
        ...
        const prompt = `Презентация товара [Название товара] в официальном стиле маркетплейса Wildberries. Фон цветной — градиент от ярко-синего к розово-сиреневому, с мягкими абстрактными волнами или динамичными линиями (как в фирменном стиле WB). В правом верхнем углу расположен официальный логотип Wildberries — черные строчные буквы, современный плавный шрифт. Сам товар расположен по центру, на переднем плане, четкий и детализированный. Вокруг товара могут быть легкие декоративные элементы: тонкие линии, точки или стилизованные брызги в фирменных цветах (оранжевый, розовый, синий), не перекрывающие товар. Стиль — современный, динамичный, модный, как в рекламных кампаниях Wildberries. Высокое качество, фотореализм, формат квадрат 1:1, яркое освещение, сочные цвета.`;
