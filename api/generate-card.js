...
export default async function handler(req, res) {
    ...
    try {
        ...
        // ⭐ НОВЫЙ ПРОМПТ (от пользователя) ⭐
        const prompt = `Product photography of ${productName}. Minimalistic composition, isolated on a pure white soft gradient background (light grey to white). Studio softbox lighting, no shadows, high resolution, 8k, sharp focus, detailed texture, photorealistic. Professional e-commerce photo for Wildberries, clean and modern style.`;
