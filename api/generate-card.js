...
Яркое витринное фото [Название товара]. Насыщенные цвета, контрастный студийный свет, цветной градиентный фон (синий/розовый/мятный). Объем, тени под предметом, глянцевый журнальный стиль. Кликбейтное фото для маркетплейса, сочное, привлекающее внимание, 4k.`;
